...
//     $q1=pg_query("SELECT DISTINCT hoa,ddocode FROM pdaccountinfo WHERE status=1 ORDER BY hoa");
//     $txt="(";
//     while($r1=pg_fetch_array($q1,null,PGSQL_ASSOC))
//     {
//         if(substr($r1['ddocode'], 2, 2) == '01' || substr($r1['ddocode'], 0, 4) == '2702' || substr($r1['ddocode'], 0, 4) == '2213') {
//             $txt=$txt."'".$r1['hoa']."',";
//         }
//     }
//     $txt=substr($txt,0,-1);
...
//     $q4=pg_query("SELECT * FROM tpayments WHERE hoa in $txt AND billstatus='9' AND utimestamp>'$date' AND utimestamp<='$mt' AND formno!='chq' ");

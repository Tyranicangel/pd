...
$q=pg_query("SELECT COUNT(*) FROM pdaccountinfo WHERE status='0'");
var_dump(pg_fetch_all($q));
$q=pg_query("SELECT * FROM pdaccountinfo WHERE status='0' ORDER BY ddocode");
?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	<title>PD Accounts Pending</title>
	<style>
		table{

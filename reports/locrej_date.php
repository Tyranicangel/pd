...
<title>LOC Rejected Date-wise Report</title>
...
<script>
	$(document).ready(function() {
		...
		$('#show_ddo').click(function() {
			...
			window.open('locrej_date_action.php?date=' +date + '&ddo=' +ddo, '_blank');
		}
	});
	});
	</script>
...
<?php
echo "<div style='margin-left:25px;margin-top:20px;font-family:arial;'><p class='each_desc'><span style='color:red;'>* </span>Please select the date of LOC request made.</p></div></br></br></br>";
echo "<input type='text' class='each_box' id='date' style='margin-left:150px;width:165px;' placeholder='Select LOC request date'></br></br></br>";

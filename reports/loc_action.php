...
echo "<head><link rel='stylesheet' type='text/css' href='../front/styles/style_common.css'><title>LOC Granted Report</title></head>";
    $result = pg_query("SELECT requestuser,reqamount,grantamount,hoa,requestdate,refno,userid,requestflag,ddtime,atotime FROM locrequest WHERE requestflag='1' AND conf_flag='6' AND userid='$tre' AND requestdate >= '2015-04-01' AND ddtime IS NOT NULL ORDER BY requestuser ");

...
echo "<head><link rel='stylesheet' type='text/css' href='../front/styles/style_common.css'><title>LOC Rejected HOA-wise Report</title></head>";
    $result = pg_query("SELECT requestuser,reqamount,hoa,requestdate,refno,userid,requestflag,ddtime,requestdate FROM locrequest WHERE requestflag='1' AND conf_flag='2' AND requestdate >= '2015-04-01' AND hoa='$hoa' AND requestuser LIKE '$ddo%' ORDER BY requestuser ");

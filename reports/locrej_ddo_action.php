...
echo "<head><link rel='stylesheet' type='text/css' href='../front/styles/style_common.css'><title>LOC Rejected DDO-wise Report</title></head>";
    $result = pg_query("SELECT reqamount,userid,requestflag,hoa,requestdate,ddtime,requestuser,refno FROM locrequest WHERE requestflag='1' AND conf_flag='2' AND requestdate >= '2015-04-01' AND requestuser LIKE '$ddo%' ORDER BY requestuser ");

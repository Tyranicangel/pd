...
echo "<head><link rel='stylesheet' type='text/css' href='../front/styles/style_common.css'><title>Cheques Paymentdone HOA-wise Report</title></head>";
    $result = pg_query("SELECT chequeno,partyname,issueuser,hoa,partyamount,transdate,confirmdate FROM transactions WHERE transstatus='3' AND transtype='1' AND transdate >= '2015-04-01' AND hoa='$hoa' AND issueuser LIKE '$ddo%' ORDER BY issueuser ");
